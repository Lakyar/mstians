<x-admin-layout2>
    ...
    <section class="w-full " style="min-height: calc(100vh - 80px)">
        <div class=" w-[90%] mx-auto mt-10 ">
            ...
            <form method="POST" class="flex flex-wrap justify-between"  enctype="multipart/form-data" action="/tournaments/{{ $tournament->id }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6 w-[30%]">
                    ...
                    <input
                        type="text"
                        class="border border-gray-900 bg-slate-900 outline-none rounded p-4 w-full text-white shadow-md shadow-black/50"
                        name="tags" value="{{$tournament->tags}}"
                ...
                <div class="mb-6 w-[20%]">
                    ...
                    <input
                        ...
                        name="images" value="{{$tournament->images}}"/>
                ...
                <div class="mb-4">
                    ...
                    @foreach($allTeams as $team)
                        <div>
                            <input type="checkbox" name="teams[]" id="team_{{ $team->id }}" value="{{ $team->id }}" {{ $tournament->teams->contains($team->id) ? 'checked' : '' }}>
                ...
                <div class="mb-6 w-full flex justify-between flex-row-reverse items-center">
                    ...
                    <a href="/tournaments/manage" class="text-white py-2 px-10  shadow-md shadow-black/50 bg-yellow-600 hover:bg-yellow-700 active:bg-black active:text-white"> Back </a>
                </div>
            </form>
        </div>
    </section>
